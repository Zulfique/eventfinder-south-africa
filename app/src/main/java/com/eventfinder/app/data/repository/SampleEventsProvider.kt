...
/**
 * Curated starter directory for the South African market. Seeded into Room on
 * first launch so the prototype is fully usable offline and without any API key.
 *
...
object SampleEventsProvider {
    ...
    /** ~14 realistic events across Johannesburg, Cape Town and Durban. */
    fun johannesburgAndCapeTown(): List<Event> {
        ...
        val eventive = listOf(
            ...
            Event(
                id = "sample-cpt-music",
                title = "Cape Town Carnival Sound",
            ...
            Event(
                id = "sample-cpt-food",
                title = "Hout Bay Food & Craft Market",
            ...
            Event(
                ...
                title = "Khayelitsha Community Clean-Up",
            ...
            Event(
                id = "sample-dbn-music",
                title = "Durban Beachfront Reggae",
            ...
            Event(
                ...
                title = "Youth Coding Bootcamp Open Day",
